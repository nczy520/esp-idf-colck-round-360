...
#define LCD_BACKLIGHT_BRIGHTNESS_PERCENT 50
#define LCD_BACKLIGHT_PWM_FREQUENCY_HZ   10000
#define LCD_BACKLIGHT_PWM_RESOLUTION     LEDC_TIMER_8_BIT
#define LCD_BACKLIGHT_PWM_MAX_DUTY       ((1U << LCD_BACKLIGHT_PWM_RESOLUTION) - 1U)

#if LCD_BACKLIGHT_BRIGHTNESS_PERCENT < 0 || LCD_BACKLIGHT_BRIGHTNESS_PERCENT > 100
...
esp_err_t bsp_backlight_init(void)
{
    ...
    const ledc_channel_config_t channel_config = {
        ...
        .duty = LCD_BACKLIGHT_ACTIVE_LEVEL ? 0 : LCD_BACKLIGHT_PWM_MAX_DUTY,
        .hpoint = 0,
    };
...
{
    uint32_t duty = (LCD_BACKLIGHT_PWM_MAX_DUTY * LCD_BACKLIGHT_BRIGHTNESS_PERCENT) / 100U;
